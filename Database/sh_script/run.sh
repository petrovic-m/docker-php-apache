...
#mysqladmin -u $mysql_usr -p$mysql_psw create $mysql_db_name
#import .sql
echo "CREATE DATABASE IF NOT EXISTS gopgo" | mysql -u admin -padmin
mysql -u admin -padmin -f -D gopgo < /database.sql
#mysql -u admin -padmin -f gopgo < ~/gpde_db_2023_03_16.sql
#import .sql
fg
